                  ...
                  <>
                    <li onClick={() => Router.push(`/user/${user.id}`)} className="userinfo">
                      { user?.avatar_url ? (
                        ...
                        <svg className="octicon octicon-mark-github v-align-middle avatar-github" width="40" height="40" viewBox="0 0 16 16" version="1.1" aria-hidden="true" fill={ theme ? '#f8f8f2' : '#29292e' }>
